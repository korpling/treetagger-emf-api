...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>treetagger</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class TreetaggerExample {
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(TreetaggerPackage.eNS_URI, 
			 TreetaggerPackage.eINSTANCE);
		...
		if (args.length == 0) {
			...
			try {
				Resource resource = resourceSet.createResource(URI.createURI("http:///My.treetagger"));
				Document root = TreetaggerFactory.eINSTANCE.createDocument();
